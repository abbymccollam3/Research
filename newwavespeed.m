...
addpath(datapath)
%addpath('/Users/quentingoossens/Documents/Work/Research/Active sensing PT/matlab scripts') % optional path where matlab scripts are located
...
for k2 = 1:number_of_bursts
            ...
            filename = [datapath 'S' num2str(k) '/segmented/S' num2str(k) '_' side{k1} '_stat_squat_c1' '.mat']; % fill in the first part of the file name
            load(filename);
